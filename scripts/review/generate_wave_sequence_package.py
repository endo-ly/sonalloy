...
def main() -> None:
    review_root = ROOT / "review-output" / "wave-sequence"
    ...
    source_paths = {
        ...
        "digital-motion.wav": ROOT / "examples" / "assets" / "digital-motion.wav",
        "stereo-texture.wav": ROOT / "review-output" / "granular-generator" / "assets" / "stereo-texture.wav",
    }
