...
pub(super) fn validate_granular(
    diagnostics: &mut Vec<Diagnostic>,
    path: &str,
    granular: &GranularDefinition,
) {
...
#[allow(clippy::too_many_lines)]
pub(super) fn validate_wave_sequence(
    diagnostics: &mut Vec<Diagnostic>,
    path: &str,
...
pub(super) fn validate_oscillator(
    diagnostics: &mut Vec<Diagnostic>,
    path: &str,
    oscillator: &OscillatorDefinition,
) {
...
pub(super) fn validate_wavetable(
    diagnostics: &mut Vec<Diagnostic>,
    path: &str,
    wavetable: &WavetableDefinition,
) {
...
pub(super) fn validate_spectral(
    diagnostics: &mut Vec<Diagnostic>,
    path: &str,
    spectral: &SpectralDefinition,
) {
...
#[allow(clippy::too_many_lines)]
pub(super) fn validate_operator_modulation(
    diagnostics: &mut Vec<Diagnostic>,
    path: &str,
...
pub(super) fn validate_physical_string(
    diagnostics: &mut Vec<Diagnostic>,
    path: &str,
...
pub(super) fn validate_additive(
    diagnostics: &mut Vec<Diagnostic>,
    path: &str,
    additive: &AdditiveDefinition,
) {
...
pub(super) fn validate_formant_profiles(
    diagnostics: &mut Vec<Diagnostic>,
    profiles_path: &str,
