...
pub use compiler::{
    ...
    CompiledGranularParameters, CompiledInstrument, CompiledInstrumentSource, CompiledLfo,
    ...
    CompiledSpectralParameters, CompiledStep, CompiledStretchLatency, CompiledVector,
    CompiledVoiceSource, CompiledVoiceStealing, CompiledWaveSequence, CompiledWaveSequenceDuration,
    CompiledWaveSequenceStep, CompiledWaveSequenceStepPlayback, CompiledWavetable,
    CompiledWavetableParameters, GeneratorOutputMode, InstrumentSourceHandle, PreparedWavetable,
    PreparedWavetableBand, PreparedWavetableFrame, SourceHandle, WavetableSourceMetadata,
    compile_instrument,
};
pub use definition::{
    ...
    LimiterProcessorDefinition, ModalDefinition, ModulationDepthDefinition,
