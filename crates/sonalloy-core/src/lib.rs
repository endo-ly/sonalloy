...
pub use compiler::{
    ...
    CompiledDelayTime, CompiledDynamicsDetector, CompiledEnvelopeTransferParameters,
    CompiledEnvelopeTransferProcessor, CompiledEqParameters, CompiledEqProcessor,
    CompiledExternalAudioInput, CompiledFlangerProcessor, CompiledFormant, CompiledFormantBand,
    CompiledFormantParameters, CompiledFormantProcessor, CompiledFormantProcessorParameters,
    CompiledFormantProfile, CompiledFrequencyShifterParameters, CompiledFrequencyShifterProcessor,
    CompiledGateParameters, CompiledGateProcessor, CompiledGranular, CompiledGranularParameters,
    CompiledInstrument, CompiledInstrumentSource, CompiledInstrumentSourceKind, CompiledLfo,
    CompiledLimiterParameters, CompiledLimiterProcessor, CompiledModal, CompiledModalParameters,
    CompiledModulationDelayParameters, CompiledMseg, CompiledMsegSegment, CompiledOperator,
    CompiledOperatorModulation, CompiledOperatorParameters, CompiledOperatorTopology,
    CompiledPerformance, CompiledPerformanceMode, CompiledPhaserParameters,
    ...
    CompiledSampleDirection, CompiledSampleHold, CompiledSampleLoop, CompiledSamplePlayback,
    CompiledSampleTime, CompiledSmoothRandom, CompiledSource, CompiledSourceRef, CompiledSpectral,
    CompiledSpectralMorphParameters, CompiledSpectralMorphProcessor, CompiledSpectralParameters,
    CompiledStep, CompiledStretchLatency, CompiledTransientShaperParameters,
    CompiledTransientShaperProcessor, CompiledVector, CompiledVocoderParameters,
...
pub use definition::{
    ...
    DriveProcessorDefinition, DynamicsDetectorDefinition, EnvelopeFollowerDefinition,
    EnvelopeTransferProcessorDefinition, EqProcessorDefinition, ExternalAudioChannels,
    ExternalAudioInputDefinition, FilterModeDefinition, FilterProcessorDefinition,
    FlangerProcessorDefinition, FormantBandDefinition, FormantDefinition,
    FormantProcessorDefinition, FormantProfileDefinition, FrequencyShifterProcessorDefinition,
    GateProcessorDefinition, GeneratorDefinition, GranularDefinition, HardSyncDefinition,
    InstrumentDefinition, InstrumentMetadata, LayerDefinition, LayerTriggerDefinition,
    LayerTriggerEvent, LimiterProcessorDefinition, ModalDefinition, ModulationDepthDefinition,
    ModulationDurationDefinition, ModulationDurationUnit, ModulationRateDefinition,
    ModulationRateUnit, ModulationSegmentCurve, MsegDefinition, MsegLoopDefinition,
    MsegSegmentDefinition, NoiseColor, NoiseDefinition, OperatorAlgorithm, OperatorDefinition,
    ...
    SpectralMorphProcessorDefinition, TransientShaperProcessorDefinition, UnisonDefinition,
    VocoderProcessorDefinition, VoiceStealingDefinition, WaveSequenceDefinition,
    WaveSequenceDirection, WaveSequenceDurationDefinition, WaveSequenceStepDefinition,
    WaveSequenceStepPlayback, WavefoldDefinition, WaveshapingDefinition, WavetableDefinition,
};
pub use definition::{
...
pub use render::{
    ...
    RenderRequest, RenderedAudio, render_instrument, render_instrument_with_input,
    render_instrument_with_input_and_reset, render_instrument_with_input_and_trace,
