        ...
        [
            {"absolute_frame": 0, "type": "note_on", "note_id": 1, "note": 48, "velocity": 112},
            {
                ...
                "native_value": native_parameter_value(
                    "layer.motion.generator.wavetable_position", 0.85
                ),
            },
            {"absolute_frame": 6144, "type": "note_on", "note_id": 2, "note": 55, "velocity": 96},
            {
                ...
                "parameter": "layer.motion.generator.wavetable_position",
                "native_value": native_parameter_value(
                    "layer.motion.generator.wavetable_position", 0.2
                ),
            },
            ...
            [
                {
                    ...
                    "native_value": native_parameter_value(position_parameter, 1.0),
                },
                {
                    "absolute_frame": 8_192,
                    "type": "parameter_change",
                    "parameter": position_parameter,
                    "native_value": native_parameter_value(position_parameter, 0.1),
                },
            ],
        ),
    )
            ...
            [
                {
                    ...
                    "native_value": native_parameter_value(ratio_parameter, 0.03),
                },
                {
                    "absolute_frame": 8_192,
                    "type": "parameter_change",
                    "parameter": ratio_parameter,
                    "native_value": native_parameter_value(ratio_parameter, 0.09),
                },
            ],
        ),
    )
            ...
            [
                {
                    ...
                    "native_value": native_parameter_value(index_parameter, 0.1),
                },
                {
                    "absolute_frame": 8_192,
                    "type": "parameter_change",
                    "parameter": index_parameter,
                    "native_value": native_parameter_value(index_parameter, 0.4),
                },
            ],
        ),
    )
            ...
            [
                {
                    ...
                    "native_value": native_parameter_value(feedback_parameter, 0.25),
                },
                {
                    "absolute_frame": 8_192,
                    "type": "parameter_change",
                    "parameter": feedback_parameter,
                    "native_value": native_parameter_value(feedback_parameter, 0.65),
                },
            ],
        ),
    )
