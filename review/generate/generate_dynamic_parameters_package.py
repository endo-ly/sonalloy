...
def main() -> None:
    review_root = ROOT / "review" / "dynamic-parameters"
    ...
    moving_source = ROOT / "testdata" / "instruments" / "moving-hybrid-pad.json"
    expressive_source = ROOT / "testdata" / "instruments" / "expressive-hybrid-lead.json"
