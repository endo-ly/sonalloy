...
PRIMARY_RENDERS = (
    RenderJob(
        ...
        "review/generate/fixtures/basic-poly-synth-sine.json",
        "testdata/midi/sine-reference.mid",
    ),
    RenderJob(
        "02-saw-registers.wav",
        "review/generate/fixtures/basic-poly-synth-saw-open.json",
    ...
    RenderJob(
        ...
        "review/generate/fixtures/basic-poly-synth-poly4.json",
...
COMPANION_RENDERS = (
    RenderJob(
        ...
        "review/generate/fixtures/basic-poly-synth-saw-closed.json",
        "testdata/midi/saw-registers.mid",
    ),
    RenderJob(
        "03-attack-release-slow-attack.wav",
        "review/generate/fixtures/basic-poly-synth-attack-slow.json",
        "testdata/midi/attack-release.mid",
    ),
)
