...
6. `metrics.json`へ機械的な測定値（観測Callback Frameの最小値・最大値・回数を含む）を、`review-summary.md`へ入力応答と音質の判断を記録する

Opaque IDはMachine-specificな値のため、公開Review Artifactへ残さない。Device Name、Backend、Sample Rate、要求Frame、観測Callback Frameの最小値・最大値・回数、Latency、Xrun、Fault状態だけを記録する。
