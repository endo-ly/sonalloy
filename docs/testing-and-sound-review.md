...
| External Audio / Cross Synthesis | Envelope Follower、External Sidechain、Vocoder、Envelope Transfer、Spectral Morph | 入力Channel、入力との時間整合、Frequency Shifter 127 frames / Spectral Morph 1024 frames後のExternal Consumer、Sidechainの非可聴動作、Speech-like articulation、Stereo差、Morph段階、startup latency、固定Latency、Reset、入力終端後の挙動、96 kHz Full Chain |
