...
| Performance / Modulation | Monophonic Lead、MSEG Pad、Tempo Step、Random / Sample & Hold / Smooth Random、Macro Hybrid、4-Way Vector | Last-note Priority、Legato、Portamento、Held Note復帰、MSEG Loop / Release、Tempo追従、Randomの決定性、Macroの複数Target、VectorのConstant-power境界 |
