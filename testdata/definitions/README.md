...
- `valid-basic-poly-synth.json` is a valid P1 Definition fixture.
- `invalid-schema-version.json` is rejected by validation because its schema version is newer than the current MVP schema.
